...
type Value_DateValue struct {
	...
	DateValue *Date `protobuf:"bytes,13,opt,name=date_value,json=dateValue,proto3,oneof"`
}
...
const file_google_bigtable_v2_data_proto_rawDesc = "" +
	...
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTimeB\xbe\x01\n" +
	"\x16com.google.bigtable.v2B\tDataProtoP\x01ZCgithub.com/mishudark/cloudpebble/pkg/bigtable/bigtablepb;bigtablepb\xaa\x02\x18Google.Cloud.Bigtable.V2\xca\x02\x18Google\\Cloud\\Bigtable\\V2\xea\x02\x1bGoogle::Cloud::Bigtable::V2b\x06proto3"
