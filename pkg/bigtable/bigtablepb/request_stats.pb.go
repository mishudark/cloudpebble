...
const file_google_bigtable_v2_request_stats_proto_rawDesc = "" +
	...
	"\n" +
	"stats_viewB\xc6\x01\n" +
	"\x16com.google.bigtable.v2B\x11RequestStatsProtoP\x01ZCgithub.com/mishudark/cloudpebble/pkg/bigtable/bigtablepb;bigtablepb\xaa\x02\x18Google.Cloud.Bigtable.V2\xca\x02\x18Google\\Cloud\\Bigtable\\V2\xea\x02\x1bGoogle::Cloud::Bigtable::V2b\x06proto3"
