...
func (x *ErrorResponse) GetRetryInfo() *RetryInfo {
	if x != nil {
		return x.RetryInfo
	}
	return nil
...
const file_google_bigtable_v2_session_proto_rawDesc = "" +
	...
	"\x10rpc_session_type\x12\x1e.google.protobuf.MethodOptions\x18\x84\xda\xe4A \x01(\x0e2\x1f.google.bigtable.v2.SessionTypeR\x0erpcSessionTypeB\xc1\x01\n" +
	"\x16com.google.bigtable.v2B\fSessionProtoP\x01ZCgithub.com/mishudark/cloudpebble/pkg/bigtable/bigtablepb;bigtablepb\xaa\x02\x18Google.Cloud.Bigtable.V2\xca\x02\x18Google\\Cloud\\Bigtable\\V2\xea\x02\x1bGoogle::Cloud::Bigtable::V2b\x06proto3"
...
func file_google_bigtable_v2_session_proto_init() {
	...
	file_google_api_resource_proto_init()
